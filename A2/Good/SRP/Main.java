...
public class Main {
    public static void main(String args[]){
            ...
            s1.setPhone_number("9029941301");
            s1.setMarks(new int[] {99,100,95,94,92});

            CalculateCGPA calculateCGPA = new CalculateCGPA(s1);
            calculateCGPA.calculateCGPA();

            PrintResult printResult = new PrintResult(s1);
            printResult.printResult();

            CalculateEligibility calculateEligibility = new CalculateEligibility(s1);
            calculateEligibility.checkScholarshipEligibility();
